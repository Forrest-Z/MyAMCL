...
#include "my/localization/lidar/ibeo/amcl/eig3.h"
...
// Print a vector
void PfVectorFprintf(PfVectorT a, FILE *file, const char *fmt)
{
  int i;
...
// Print a matrix
void PfMatrixFprintf(PfMatrixT a, FILE *file, const char *fmt)
{
  int i, j;
